...
return (_ctx, _cache) => {
  return (_openBlock(), _createElementBlock(_Fragment, null, [
    (show.value)
      ? (_openBlock(), _createElementBlock("h1", _hoisted_1, _toDisplayString(msg.value) + " " + _toDisplayString(__props.item), 1 /* TEXT */))
    ...
    _cache[1] || (_cache[1] = _createElementVNode("span", null, null, -1 /* CACHED */))
  ], 64 /* STABLE_FRAGMENT */))
}
}
